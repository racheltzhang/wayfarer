...
export const MOCK_TRIPS: Trip[] = [
  ...
  },
  {
    ...
    country_emoji: '🇺🇸',
    duration_days: 3,
    cover_image_url: 'https://picsum.photos/seed/nyc22/800/500',
    description: 'Three perfect days eating, walking, and getting lost in Manhattan.',
    visibility: 'public',
    rating: null,
    rating_count: 0,
    like_count: 4,
    ...
    days: [
      {
        id: 'dm-1', trip_id: 'trip-me-1', title: 'Downtown & Food Hall', day_number: 1,
        activities: [
          { id: 'dm-a1', emoji: '✈️', text: 'Arrive JFK, AirTrain to subway', type: 'transit', notes: null, position: 0 },
          { id: 'dm-a2', emoji: '🏨', text: 'Check in — Midtown hotel', type: 'stay', notes: null, position: 1 },
          { id: 'dm-a3', emoji: '🥩', text: 'Dinner at Katz\'s Deli', type: 'food', notes: 'Get the pastrami on rye', position: 2 },
        ],
      },
      {
        id: 'dm-2', trip_id: 'trip-me-1', title: 'Central Park & Museums', day_number: 2,
        activities: [
          { id: 'dm-b1', emoji: '🌿', text: 'Morning run in Central Park', type: 'outdoors', notes: null, position: 0 },
          { id: 'dm-b2', emoji: '🏛️', text: 'The Metropolitan Museum of Art', type: 'culture', notes: 'Go straight to Egyptian wing', position: 1 },
          { id: 'dm-b3', emoji: '🍕', text: 'Joe\'s Pizza in Greenwich Village', type: 'food', notes: null, position: 2 },
          { id: 'dm-b4', emoji: '🌃', text: 'Rooftop bar at sunset', type: 'night', notes: '230 Fifth has great views', position: 3 },
        ],
      },
    ],
  },
